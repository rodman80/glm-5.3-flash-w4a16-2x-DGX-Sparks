...
# NOTE (this recipe): SM121 top-k fix via tonyd2wild/GLM-5.3-Flash-NVFP4-DFlash2-2x-DGX-Spark
# (docker/sparse_attn_indexer_kpool_sm121.py) — see recipe README Credits.
